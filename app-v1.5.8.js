(() => {
  ...
  /***************************************************************************
   * Meowmoon Bowling v1.5.8 eight-animation-bundle
   * Replaces Cardinal Glide with v3 and adds seven approved special animations.
   * Design: no choices, no score, no frames, no losing, no ads, no timers.
   **************************************************************************/

  console.log("Meowmoon Bowling code loaded: v1.5.8 eight-animation-bundle");
