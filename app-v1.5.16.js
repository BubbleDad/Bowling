(() => {
  ...
  /***************************************************************************
   * Meowmoon Bowling v1.5.16 jellybean-safe-area-fix
   * Keeps Jellybean Row Color Pop v3 fully inside the visible safe area.
   * Design: no choices, no score, no frames, no losing, no ads, no timers.
   **************************************************************************/

  console.log("Meowmoon Bowling code loaded: v1.5.16 jellybean-safe-area-fix");
