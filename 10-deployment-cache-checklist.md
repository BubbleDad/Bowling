...
- `index.html` should reference `app-v1.5.5.js`.
- `sw.js` should cache `./app-v1.5.5.js`.
- `sw.js` should use `meowmoon-bowling-v1-5-5-regional-animations-cache`.
- the console marker should say v1.5.5.
